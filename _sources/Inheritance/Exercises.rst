...
Here's _all_ the code we just saw for our new and improved game, with a few additions. You can run this and play the game again.

.. activecode:: tamagotchi_revisited2
    :nocanvas:
    ...
    # Here is a good place to add another class.
    ...
    def whichtype(adopt_type="general pet", name):
        if adopt_type.lower() == "dog":
            ...
            return Poodle(name)
        # Add some code here to return a tiger pet
        else:
            return Pet(name)
