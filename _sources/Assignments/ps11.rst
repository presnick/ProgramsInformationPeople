...
.. external:: ps_11_preamble
    ...
    **ABOUT THIS PROBLEM SET**
    ...
    To run this problem set, you will need to download all of the files in the folder Files > Problem Sets > PS12. 

    You should edit and submit the ``106_ps12.py`` file, which should run if it is in a directory with all the other files we provided.

.. external:: ps_11_01

	**PROBLEM 1**

	First, make a 1-player Pong game: a game where the right-most wall just reflects the ball back instead of scoring a point. 
