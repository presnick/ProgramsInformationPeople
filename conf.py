...
project = u'Programs, Information, and People'
copyright = u'2013 Paul Resnick, Brad Miller, David Ranum, Created using Runestone Interactive'
...
html_theme_options = {
    ...
    'navbar_title': "Programs, Information, and People",
...
html_title = 'Programs, Information, and People: Interactive Edition'

# A shorter title for the navigation bar.  Default is the same as html_title.
html_short_title = 'Programs, Information, and People'
...
latex_documents = [
  ('index', 'PIP.tex', u'Programs, Information, and People',
   u'Paul Resnick, Brad Miller, David Ranum', 'manual'),
]
...
man_pages = [
    ('index', 'PIP', u'Programs, Information, and People',
     [u'Paul Resnick, Brad Miller, David Ranum'], 1)
]
