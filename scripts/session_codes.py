...
sessions[3] = ["PythonTurtle/intro-HelloLittleTurtles.rst", "PythonTurtle/OurFirstTurtleProgram.rst", "PythonTurtle/InstancesAHerdofTurtles.rst", "PythonTurtle/ObjectInstances.rst", "Debugging/intro-HowtobeaSuccessfulProgrammer.rst", "Debugging/BeginningtipsforDebugging.rst", "Debugging/KnowyourerrorMessages.rst", "Debugging/Summary.rst"]
...
sessions[5] += ["Unix/CommandPrompt.rst", "Unix/FoldersAndPaths.rst"]
...
sessions[6]+= [ "BuildingAProgram/UnderstandingCode.rst"]
...
sessions[8] = ["DictionaryAccumulation/intro-AccumulatingMultipleResultsInaDictionary.rst", "DictionaryAccumulation/AccumulatingResultsFromaDictionary.rst", "DictionaryAccumulation/AccumulatingaMaximumValue.rst", "DictionaryAccumulation/AccumulatingtheBestKey.rst", "DictionaryAccumulation/Exercises.rst", "Unix/lessCommand.rst", "BuildingAProgram/TheStrategy.rst"]
...
sessions[10] = ["IndefiniteIteration/intro-indefiniteiteration.rst", "IndefiniteIteration/ThewhileStatement.rst", "IndefiniteIteration/listenerLoop.rst"]
